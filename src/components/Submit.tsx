  ...
  return (
    <>
      <div className="w-full rounded-lg bg-white p-6 md:p-10">
        ...
        <input
          className="flex h-full w-full rounded-md px-3 py-2 text-sm text-zinc-800 ring-1 ring-inset ring-gray-200 focus:outline-none focus:ring-gray-400 dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10"
          placeholder=""
          value={email}
          onChange={(event) => {
